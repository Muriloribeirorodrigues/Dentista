...
public class ConsultaPacientesEndereco extends javax.swing.JFrame {
    ...
    int countCPF = 0;
    /**
     * Creates new form ConsultaPacientesEndereco
     */
    public ConsultaPacientesEndereco() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Insira O Cpf Do Paciente");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(510, 30, 140, 20);
    ...
    private void ConsultaGeralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConsultaGeralActionPerformed
            try {
            resposta = ed.ConsultaGeralEndClientes();
            int linha=0;
    ...
    private void ConsultaPorCPFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConsultaPorCPFActionPerformed
            ...
            resposta = ed.ConsultaPorCPFClientes(CPF);
            int linha=0;
            //percorre todas as linhas do result set
            while(resposta.next()){
                campotabela.setRowCount(linha+1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaPacientesEndereco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
