 ...
 * @author guto4
 */
public class ConsultaDentistaCadastrado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Dentistas Cadastrados");
        ...
        Voltar.setBounds(0, 463, 90, 30);

        jLabel1.setText("Insira O CPF Do Dentista");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(520, 30, 140, 20);
        ...
        ConsultaPorCPF.setBounds(660, 70, 130, 23);
    ...
    private void ConsultaGeralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConsultaGeralActionPerformed
            try {
        resposta = dpc.ConsultaGeralDentistas();
            int linha=0;
            //percorre todas as linhas do result set
            while(resposta.next()){
                campotabela.setRowCount(linha+1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaDentistaCadastrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
