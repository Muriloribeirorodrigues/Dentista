 ...
 * @author guto4
 */
public class DeletarDentista extends javax.swing.JFrame {
    private Image imagemOriginalCache = null;
    int countCPF = 0;
    /**
     * Creates new form DeletarDentista
     */
    ...
    private void initComponents() {
        ...
        DeletarDentista = new javax.swing.JButton();
        jLabel1 = new javax.swing.JLabel();
        tCPF = new javax.swing.JTextField();
        Imagem = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Deletar Dentista");
        ...
        DeletarDentista.setText("Deletar Dentista");
        DeletarDentista.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DeletarDentistaActionPerformed(evt);
            }
        });
        getContentPane().add(DeletarDentista);
        DeletarDentista.setBounds(620, 290, 150, 23);

        jLabel1.setText("Informe O CPF do Dentista Que Deseja Deletar");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(370, 250, 270, 20);
    ...
    private void DeletarDentistaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeletarDentistaActionPerformed
    String CPF = tCPF.getText();
    DadosPessoaisC dp = new DadosPessoaisC();
    dp.DeletarRegistroDentistas(CPF);

    dispose();
    new ConcluiuAExclusao().setVisible(true);
    }//GEN-LAST:event_DeletarDentistaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeletarDentista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton DeletarDentista;
